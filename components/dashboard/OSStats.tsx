...
export const OSStats: React.FC<OSStatsProps> = ({ data }) => {
    ...
    return (
        <div className="bg-white rounded-[2rem] p-6 pb-10 border border-stone-200 shadow-sm flex flex-col min-h-full transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-1 card-hover relative">
            ...
            <div className="flex-1 flex flex-col items-center justify-center min-h-[250px] w-full h-full">
                <div className="relative w-full h-full min-h-[250px] flex items-center justify-center">
                    ...
                    <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={0} initialDimension={{ width: 300, height: 250 }}>
                        <PieChart>
                            <Pie
                                data={chartData}
                                innerRadius="60%"
