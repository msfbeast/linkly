        ...
        <AnimatePresence mode="wait">
            {isMinimized ? (
                <motion.button
                    ...
                    className="fixed bottom-24 right-6 z-50 flex items-center gap-2 bg-slate-900 text-white px-4 py-3 rounded-full shadow-lg shadow-slate-900/20 hover:bg-slate-800 transition-colors group"
                >
                ...
                <motion.div
                    ...
                    className="fixed bottom-24 right-6 z-50 flex items-center gap-4 bg-slate-900 text-white p-4 rounded-2xl shadow-xl shadow-slate-900/20 max-w-sm cursor-default"
                >
