-- Update analytics aggregation to use visitor_id
-- Run this in Supabase SQL Editor

-- 1. Get aggregated click stats for a user's links
DROP FUNCTION IF EXISTS get_user_click_stats(UUID);
...
-- 2. Get stats for a specific link
DROP FUNCTION IF EXISTS get_link_stats(UUID);
