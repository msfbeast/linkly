-- Update record_click function to support device_model (v2)
-- Run this in Supabase SQL Editor AFTER running 20251205_device_model_breakdown.sql
...
BEGIN
    ...
    INSERT INTO click_events (
        ...
        utm_content,
        trigger_source,
        visitor_id,        -- From previous update
        device_model,      -- New field
        ...
        p_click_data->>'deviceModel',     -- Map from input JSON
        p_click_data->>'destinationUrl'
    );
END;
$$;
